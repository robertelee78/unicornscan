...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_cfgfile = 17,                   /* cfgfile  */
  YYSYMBOL_section = 18,                   /* section  */
  YYSYMBOL_glines = 19,                    /* glines  */
  YYSYMBOL_plines = 20,                    /* plines  */
  YYSYMBOL_mlines = 21,                    /* mlines  */
  YYSYMBOL_g_statement = 22,               /* g_statement  */
  YYSYMBOL_p_statement = 23,               /* p_statement  */
  YYSYMBOL_m_statement = 24,               /* m_statement  */
  YYSYMBOL_multi_line_str = 25,            /* multi_line_str  */
  YYSYMBOL_line_str = 26,                  /* line_str  */
  YYSYMBOL_pdata = 27                      /* pdata  */
};
